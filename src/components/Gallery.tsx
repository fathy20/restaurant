...
const photos = [
  { src: `${BASE}food-bg.jpeg`, alt: "مشويات مشكلة من مطعم الضيافة", label: "مشويات مشكلة", span: "col-span-2 row-span-2" },
  ...
  { src: `${BASE}food-bg.jpeg`, alt: "أجواء مطعم الضيافة", label: "أجواؤنا" },
];
