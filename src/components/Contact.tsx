    ...
    <section id="contact" className="py-24 bg-djafa-black">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              ...
              <div>
                ...
                <span className="text-white group-hover:text-djafa-yellow transition-colors text-sm">info@aldiyafa.ly</span>
              </div>
            </a>
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-djafa-red/15 flex items-center justify-center flex-shrink-0 group-hover:bg-djafa-red/25 transition-colors">
                <Phone size={20} className="text-djafa-red" />
              </div>
              <div>
                <p className="text-djafa-yellow text-xs tracking-widest uppercase mb-0.5">رقم الهاتف</p>
                <span className="text-white group-hover:text-djafa-yellow transition-colors text-sm" dir="ltr">+218 91 000 0000</span>
              </div>
            </a>
          </div>
          ...
          <a href="https://wa.me/218910000000?text=مرحباً، أريد الاستفسار عن مطعم الضيافة"
            target="_blank" rel="noopener noreferrer"
            className="flex items-center justify-center gap-3 w-full py-4 bg-[#25D366] text-white font-bold rounded-xl hover:bg-[#1da851] transition-all duration-300 shadow-lg shadow-green-500/20">
